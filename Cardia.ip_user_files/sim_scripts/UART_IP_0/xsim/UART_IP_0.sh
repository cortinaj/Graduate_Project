...
#
# Script generated by Vivado on Sun Feb 15 18:34:15 -0800 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : UART_IP_0.sh
...
#
# Usage        : UART_IP_0.sh
#                UART_IP_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                UART_IP_0.sh [-reset_run]
#                UART_IP_0.sh [-reset_log]
#                UART_IP_0.sh [-help]
#
...
# script info
echo -e "UART_IP_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./UART_IP_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot UART_IP_0 xil_defaultlib.UART_IP_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim UART_IP_0 -key {Behavioral:sim_1:Functional:UART_IP_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb UART_IP_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./UART_IP_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: UART_IP_0.sh [-help]\n\
Usage: UART_IP_0.sh [-step]\n\
Usage: UART_IP_0.sh [-lib_map_path]\n\
Usage: UART_IP_0.sh [-reset_run]\n\
Usage: UART_IP_0.sh [-reset_log]\n\
Usage: UART_IP_0.sh [-keep_index]\n\
Usage: UART_IP_0.sh [-noclean_files]\n\n\
